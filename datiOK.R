...
#DI RACCOLTA DEL DATO (era stata replicata in precedenza)
dataset_sort<-dataset_sort[,-nzv]
dataset_sort<-dataset_sort[,-which(colnames(dataset_sort)=="ETCH_TIME")]

#ALCUNE VARIABILI HANNO CORRELAZIONE PARI A 1 (NE TOLGO UNA)
...
#threshold= VALORE SOGLIA (PER XGBOOST DIEGO AVEVA FISSATO 0.0225)
#n.smooth= NUMERO DI FINESTRE DI LISCIAMENTO (es: n.smooth=5 la funzione fa una media
#mobile di una matrice 5x5)
Smooth.matrix<-function(dataset,threshold,n.smooth){
